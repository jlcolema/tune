						...
						<?php
							...
							foreach($items as $item):
								...
								if($counter % 2) {
									...
									$image_url = wp_get_attachment_image_src( get_post_thumbnail_id($item->ID), 'work-grid');
									$image_url = $image_url[0];
										...
										echo '<div class="text">';
											...
											echo '<p class="cta"><a href="' . get_permalink($item->ID)  . '" itemprop="url">View Project</a></p>';
